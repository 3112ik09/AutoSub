...
#     print("Please download the speaker model from https://alphacephei.com/vosk/models and unpack as {} in the current folder.".format())
#     exit(1)
spk_model_path = '/home/ishu/Desktop/speach/ja'
wf = wave.open("/home/ishu/Desktop/AutoSub/con.wav", "rb")
...
while True:
    ...
    if rec.AcceptWaveform(data):
        ...
        if 'spk' in res:
            ...
            print("Speaker distance:", cosine_dist(
                spk_sig, res['spk']), "based on", res['spk_frames'], "frames")
